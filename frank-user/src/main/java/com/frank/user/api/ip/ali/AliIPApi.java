package com.frank.user.api.ip.ali;

import com.alibaba.fastjson.JSONObject;
import com.frank.core.util.http.HttpUtil;
import com.frank.user.api.ip.ali.bean.FSIPResult;
import com.frank.user.api.ip.ali.bean.GDIPResult;
import com.frank.user.api.ip.ali.bean.HCIPResult;
import com.frank.user.api.ip.ali.bean.YYIPResult;

import java.util.HashMap;
import java.util.Map;

public class AliIPApi {
